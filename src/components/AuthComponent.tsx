    ...
    >
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">
          {isLogin ? 'Sign in to access your analytics' : 'Join to start analyzing images'}
        </p>
      </div>
      ...
      {!isLogin && (
        ...
        >
          <h3 className="text-sm font-medium text-blue-800 mb-2">Free Plan Includes:</h3>
          <ul className="text-sm text-blue-700 space-y-1">
            <li>• 10 image analyses per day</li>
